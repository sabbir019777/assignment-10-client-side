...
const testimonialsData = [
...

  {
    ...
    image:
      "https://i.postimg.cc/qMLFJTXv/7b0bbeea-c9de-4447-a609-0207ecc08ac0.jpg",
    rating: 4.8,
...

  {
    ...
    image: "https://i.postimg.cc/Xq29PQd8/IMG-E3400.jpg",
    rating: 5,
...
const Testimonials = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      ...
      if (mouseGradientRef.current) {
        mouseGradientRef.current.style.background = `radial-gradient(circle at ${
          x * 100
        }% ${y * 100}%, rgba(255, 215, 0, 0.3), transparent 70%)`;
      }
    };
  ...
  const TestimonialCard = ({ testi, idx }) => (
    <div
      key={testi.id + "-" + idx}
      className="relative bg-gray-800/70 backdrop-blur-md border border-gray-700 rounded-2xl overflow-hidden p-6 shadow-xl hover:shadow-2xl transition-all duration-300 group shrink-0 w-[350px] mx-4"
    >
      {/* Top Accent */}

      <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-amber-400 to-pink-500 rounded-t-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      ...
      <div className="absolute bottom-4 right-4 w-8 h-8 rounded-full bg-linear-to-br from-amber-400 to-pink-500 flex items-center justify-center shadow-lg">
  ...
  return (
    <section className="relative min-h-screen py-20 bg-linear-to-br from-gray-900 via-gray-900 to-gray-900 overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div
          ref={mouseGradientRef}
          className="absolute inset-0 opacity-10 transition-all duration-300"
        ></div>
        <div className="absolute w-[400px] h-[400px] -top-52 -left-24 rounded-full bg-linear-to-br from-amber-400 to-pink-500 opacity-20 animate-[float_25s_infinite_ease-in-out]"></div>
        <div className="absolute w-[500px] h-[500px] -bottom-64 -right-48 rounded-full bg-linear-to-br from-pink-500 to-fuchsia-600 opacity-20 animate-[float_25s_infinite_ease-in-out] animation-delay-5000"></div>
      </div>

      <div className="relative z-10 container mx-auto px-5 max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-playfair font-bold text-transparent bg-clip-text bg-linear-to-r from-amber-400 via-pink-500 to-rose-500 uppercase tracking-wide">
            What Our Customers Say
          </h2>
          <div className="w-20 h-1 bg-linear-to-r from-amber-400 to-pink-500 mx-auto my-4 rounded-full"></div>
          <p className="text-gray-300 mt-4 max-w-3xl mx-auto text-base sm:text-lg font-light">
            Hear from our satisfied clients who experience excellence with every
            rides.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex w-fit marquee-content-left" ref={marqueeRef1}>
          ...
          >
            <div className="flex w-fit marquee-content-right" ref={marqueeRef2}>
        ...
        <div className="mt-20 flex justify-center">
          <div className="w-48 h-1 bg-linear-to-r from-transparent via-pink-500 to-transparent rounded-full"></div>
        </div>
      </div>
      <style>
        {`
